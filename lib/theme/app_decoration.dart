...
class AppDecoration {
  ...
  static BoxDecoration get textstylepoppinsregular124 => BoxDecoration(
        color: ColorConstant.blue50,
        border: Border.all(
          color: ColorConstant.blue50,
          width: getHorizontalSize(
  ...
  static BoxDecoration get textstylepoppinsregular123 => BoxDecoration(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            5.00,
          ),
  ...
  static BoxDecoration get textstylepoppinsbold128 => BoxDecoration(
        color: ColorConstant.whiteA700,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            5.00,
  ...
  static BoxDecoration get textstylepoppinsbold147 => BoxDecoration(
        color: ColorConstant.whiteA700,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            24.00,
  ...
  static BoxDecoration get textstylepoppinsbold129 => BoxDecoration(
  ...
  static BoxDecoration get textstylepoppinsbold126 => BoxDecoration(
        color: ColorConstant.blue50,
      );
  static BoxDecoration get textstylepoppinsbold162 => BoxDecoration(
        color: ColorConstant.lightBlueA200,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            5.00,
  ...
  static BoxDecoration get textstylepoppinsbold127 => BoxDecoration(
        color: ColorConstant.whiteA700,
      );
  static BoxDecoration get textstylepoppinsbold1210 => BoxDecoration(
        color: ColorConstant.lightBlueA200,
  ...
  static BoxDecoration get groupstyleblue50 => BoxDecoration(
        color: ColorConstant.blue50,
      );
  static BoxDecoration get groupstylelightBlueA200cornerradius => BoxDecoration(
        color: ColorConstant.lightBlueA200,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            5.00,
