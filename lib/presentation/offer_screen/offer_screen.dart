                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                          ...
                                                                          child: Text(
                                                                              ...
                                                                              style: AppStyle.textstylepoppinsbold161.copyWith(fontSize: getFontSize(16), letterSpacing: 0.50))),
                                                                      Padding(
                                                                          padding: EdgeInsets.only(
                                                                          ...
                                                                          child: Text(
                                                                              ...
                                                                              textAlign: TextAlign.center,
                                                                              style: AppStyle.textstylepoppinsbold142.copyWith(fontSize: getFontSize(14), letterSpacing: 0.07))),
                                                                      Padding(
                                                                          padding: EdgeInsets.only(
                                                                              left: getHorizontalSize(
                                                                                  4.00)),
                                                                          child: Container(
                                                                              ...
                                                                              child: Text("lbl_34".tr, textAlign: TextAlign.center, style: AppStyle.textstylepoppinsbold161.copyWith(fontSize: getFontSize(16), letterSpacing: 0.50)))),
                                                                      Padding(
                                                                          padding: EdgeInsets.only(
                                                                              left: getHorizontalSize(
                                                                                  4.00),
                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child: Container(
                                                                              ...
                                                                              width: getHorizontalSize(42.00),
                                                                              decoration: AppDecoration.textstylepoppinsbold161,
                                                                              child: Text("lbl_52".tr, textAlign: TextAlign.center, style: AppStyle.textstylepoppinsbold161.copyWith(fontSize: getFontSize(16), letterSpacing: 0.50))))
                                                                    ]))
                                                          ])))
                                            ])),
                                    Padding(
