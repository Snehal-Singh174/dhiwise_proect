import '../choose_credit_or_debit_card_screen/widgets/group63_item_widget.dart';
import 'controller/choose_credit_or_debit_card_controller.dart';
import 'models/group63_item_model.dart';
                                        ...
                                        Padding(
                                            ...
                                            child: Obx(() =>
                                                CarouselSlider.builder(
                                                    ...
                                                    itemBuilder: (context,
                                                        index, realIndex) {
                                                      Group63ItemModel model =
                                                          controller
                                                              .chooseCreditOrDebitCardModelObj
                                                              .value
                                                              .group63ItemList[index];
                                                      return Group63ItemWidget(
                                                          model);
                                                    }))),
                                        Align(
