import '../product_detail_screen/widgets/group27_item_widget.dart';
                                            ...
                                            children: [
                                              Obx(() => CarouselSlider.builder(
                                                  ...
                                                  itemBuilder: (context, index,
                                                      realIndex) {
                                                    Group27ItemModel model =
                                                        controller
                                                            .productDetailModelObj
                                                            .value
                                                            .group27ItemList[index];
                                                    return Group27ItemWidget(
                                                        model);
                                                  })),
                                              Align(
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                              ...
                                                                              overflow: TextOverflow.ellipsis,
                                                                              textAlign: TextAlign.left,
                                                                              style: AppStyle.textstylepoppinsbold143.copyWith(fontSize: getFontSize(14), letterSpacing: 0.50)),
                                                                          Padding(
